...
internal class MainSettings(context: Context) : IMainSettings {
    ...
    override var isAutoDownload_music_charging_only: Boolean
        get() = getPreferences(app).getBoolean("auto_download_music_charging_only", true)
        set(v) { getPreferences(app).edit { putBoolean("auto_download_music_charging_only", v) } }
